...
import { i as g } from "./Geo-DALuw2l2.js";
import { D as w } from "./DesignAsyncAbstract-D-BgPzA9.js";
import { C as H } from "./GeoIntl-CUd2jzS4.js";
import { I as y } from "./Icons-DOTKrEyY.js";
import { G as j } from "./GeoFlag-D1Br7H3P.js";
import { i as A, t as p } from "./toNumber-CJS0fvr_.js";
import { g as W } from "./getElementId-CyEaj3Ao.js";
import { E as F } from "./EventItem-7-MD1Y0R.js";
import { i as E } from "./isFilled-B_gpJgL6.js";
const $ = 1280;
class k {
  /**
...
class I {
   ...
   */
  static isPdf(t) {
    return console.log("file", t), g(t) ? !!t.match(/\.pdf$/i) : !!t.type.match(/\/pdf$/i);
  }
  /**
   * Applications asynchronously read the contents of files (or raw data buffers) stored on the user's computer.<br>
   * Асинхронно читать содержимое файлов (или буферы данных), хранящиеся на компьютере пользователя.
