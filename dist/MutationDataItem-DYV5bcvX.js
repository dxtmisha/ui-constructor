...
import { g as E } from "./getElementId-BUNC3Zxy.js";
...
const g = "d-mutation", v = p(C("DESIGNS_MAIN", "design")), b = p(C("DESIGNS_GLOBAL", "ui")), l = "__UI_PROJECT";
class c {
  /**
...
class x {
  ...
  getComponentName() {
    ...
    return a.isComponent(t) ? t : m(`${v}-${this.componentName}`);
  }
  /**
   ...
   */
  getDesign() {
    return p(this.getComponentName()).replace(/-.*?$/, "");
  }
  /**
