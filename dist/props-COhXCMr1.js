...
import { i as g } from "./Geo-BOuiw8Eo.js";
import { a as w } from "./DesignAsyncAbstract-Bi5cMulT.js";
import { C as H } from "./GeoIntl-DH3GBVnO.js";
import { I as y } from "./Icons-CdwVzsbE.js";
import { G as j } from "./GeoFlag-DfvLx1lW.js";
import { i as A } from "./isArray-QlWcxgml.js";
import { g as W } from "./getElementId-D4gB7mP1.js";
import { t as p } from "./toNumber-eA5ODeva.js";
import { E as F } from "./EventItem-CNRiCeQO.js";
import { i as E } from "./isFilled-ClO-1E4U.js";
const $ = 1280;
class k {
  /**
...
class I {
   ...
   */
  static isPdf(t) {
    return g(t) ? !!t.match(/\.pdf$/i) : !!t.type.match(/\/pdf$/i);
  }
  /**
   * Applications asynchronously read the contents of files (or raw data buffers) stored on the user's computer.<br>
   * Асинхронно читать содержимое файлов (или буферы данных), хранящиеся на компьютере пользователя.
...
class h {
   ...
   */
  static make() {
    this.event && this.objects.length < 1 ? (this.event.stop(), this.event = void 0) : this.objects.length > 0 && (this.event = new F(window, ["scroll-sync"], () => this.start()).start(), this.start());
  }
  /**
...
class N {
  ...
  getWidth() {
    var t;
    return p(((t = this.props) == null ? void 0 : t.objectWidth) ?? 0);
  }
  /**
  ...
  getHeight() {
    var t;
    return p(((t = this.props) == null ? void 0 : t.objectHeight) ?? 0);
  }
  /**
...
class _ {
  ...
  getSizeForItem() {
    ...
    return t && E(t) ? t.toString().match(/%$/) ? this.getSize(t, t) : t.toString() : null;
  }
}
let L = class extends w {
  ...
  constructor(e, i, r) {
    ...
    a(this, "adaptiveItem");
    a(this, "background");
    this.props = e, this.callback = r, this.type = new M(e), this.data = new O(e, this.type, () => {
      this.adaptiveItem.is() && this.adaptiveItem.reset(), this.make(!0);
    }), this.coordinator = new P(e), this.position = new R(e, this.coordinator), this.adaptiveItem = new N(
      e,
      this.data,
      i,
      () => this.make(!0)
   ...
   */
  getText() {
    const e = this.type.get();
    if (e === n.pdf) {
      const r = this.data.getImage();
      if (g(r))
        return r;
    }
   ...
   */
  async initEvent() {
    (!this.event.image || this.isChanged("image", ["value", "url"])) && (this.event.image = this.getData().getImage()), this.event.styles = this.initStyles();
  }
  /**
...
class nt extends B {
  ...
  constructor(e, i, r) {
    ...
    this.image = new U(
      this.props,
      this.element
    ), this.init(), C(() => this.image.destructor()), x(
      this.image.data,
      (o) => {
        var c;
  ...
  renderValue() {
    const e = this.setup();
    return e.type.value === n.pdf ? [m("object", { data: e.data.value })] : e.text.value;
  }
}
const X = {
  adaptiveGroup: "basic"
