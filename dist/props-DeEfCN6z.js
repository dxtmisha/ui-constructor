...
import { watchEffect as f, computed as o, shallowRef as c, h as u } from "vue";
import { D as S } from "./DesignConstructorAbstract-ZQD6lBiI.js";
import { D as V, t as h } from "./toNumber-BeBr0lVX.js";
class x extends V {
  /**
   * Constructor
  ...
  getValue() {
    var e;
    return h(((e = this.props) == null ? void 0 : e.value) ?? 0);
  }
  /**
  ...
  getMax() {
    var e;
    return h(((e = this.props) == null ? void 0 : e.max) ?? 100);
  }
  /**
  ...
  makeVisible() {
    return new Promise((e, i) => {
      var p, v, b, d;
      const n = (p = this.props) == null ? void 0 : p.visible, r = h(((v = this.props) == null ? void 0 : v.delay) ?? 0), m = h(((b = this.props) == null ? void 0 : b.delayHide) ?? 0);
...
class C {
  ...
  constructor(s) {
    a(this, "item");
    a(this, "tag", o(() => this.item.getTag()));
    a(this, "valueInPercent", o(() => this.item.getValueInPercent()));
    a(this, "hide", c(!1));
    a(this, "visible", c(!1));
    a(this, "classes", c({}));
    a(this, "styles", o(() => this.item.getStyles()));
