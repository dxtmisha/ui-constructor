...
var r = { VITE_PREFIX: "__dUi", VITE_DESIGNS: "m2,m3,c1,c2", VITE_DESIGNS_MAIN: "m3", VITE_DESIGNS_GLOBAL: "UI", VITE_DESIGNS_ALTER: "CC", VITE_UI_GIT: "git+https://github.com/dxtmisha/ui-playground.git", VITE_UI_WEB: "https://ru.dev2.coralclub.app", VITE_UI_PATH: "/ui/icons/", VITE_UI_API_URL: "/restApi/", VITE_UI_API_TRANSLATE: "/restApi/uiTranslate", BASE_URL: "/", MODE: "production", DEV: !1, PROD: !0, SSR: !1 };
const c = {
  api: {
    index: "UI_API_URL",
    value: "/api/"
...
class v {
  ...
  get(e) {
    ...
    if (typeof process < "u") {
      const a = ((s = process.env) == null ? void 0 : s[t]) ?? ((n = process.env) == null ? void 0 : n[`VUE_APP_${t}`]) ?? ((l = process.env) == null ? void 0 : l[`NUXT_${t}`]);
      if (a)
        return o(a);
    }
    return o(
...
class x {
  ...
  constructor(e, t = !1) {
    ...
    n && (this.value = n.value, this.age = n.age), h[s] = this;
  }
  /**
   ...
   */
  isCache(e) {
    return f(e) || this.age && this.age + e * 1e3 >= (/* @__PURE__ */ new Date()).getTime();
  }
  /**
