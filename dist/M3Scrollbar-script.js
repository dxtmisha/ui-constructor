...
import { D as E } from "./DataStorage-BS0mwKb9.js";
import { E as _ } from "./EventItem-CNRiCeQO.js";
class a {
  /**
...
r(a, "storage", new E("scrollbar", !0)), r(a, "calculate", !1);
const h = 8;
class T {
  /**
   * Constructor
   ...
   */
  start() {
    return this.event ? this.event.start() : this.event = new _(
      this.element.value,
      ["scroll-sync"],
      () => this.on()
    ).start(), this.on(), this;
...
class R extends D {
  ...
  constructor(s, i, o) {
    ...
    r(this, "scrollbar");
    this.scrollbar = new M(this.props, this.element), this.init();
  }
  /**
