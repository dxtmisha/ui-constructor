...
import { I as b, j as d, a as S, f as x } from "./Icons-VzTJi41V.js";
import { C, G as z, q as w, i as H, E as B, a as j, n as m, x as g, H as f, F as p, w as W, I as A, Q as E, O as F, M, W as O, X as $, L as R } from "./EventItem-DCn0MGCR.js";
...
class P {
   ...
   */
  static getSRC(t, e, i = G) {
    var a;
    if ((e instanceof File || e === void 0) && (t.naturalHeight > i || t.naturalWidth > i)) {
      const o = t.naturalWidth >= t.naturalHeight, h = (a = document.createElement("canvas")) == null ? void 0 : a.getContext("2d");
      return h ? (h.canvas.width = o ? i : t.naturalWidth / t.naturalHeight * i, h.canvas.height = o ? t.naturalHeight / t.naturalWidth * i : i, h.drawImage(t, 0, 0, h.canvas.width, h.canvas.height), h.canvas.toDataURL()) : "";
    } else
      return t.src;
  }
  /**
  ...
  async initImage() {
    ...
    if (e)
      switch (this.type.get()) {
        ...
        case n.icon:
          if (d(e))
            return await b.get(e, (a = this.props) == null ? void 0 : a.url);
          break;
      }
  }
}
class N {
  ...
  is() {
    ...
    return H(t) && t.length > 0 && t.length < 5;
  }
  /**
...
class Y {
   ...
   */
  update() {
    this.is() ? c.add(this) : c.remove(this);
  }
  /**
   ...
   */
  reset() {
    this.is() && (c.is(this) ? c.reset() : c.add(this));
  }
  /**
  ...
  make() {
    ...
    if (this.beyond = !1, this.visible = !1, this.is())
      if ((t = this.props) != null && t.adaptiveAlways)
        ...
        i && (this.beyond = !(i.bottom < 0 - v || i.top > window.innerHeight + v), this.visible = !(i.bottom < 0 || i.top > window.innerHeight));
      }
    return this;
  }
  /**
...
class T {
  ...
  getSizeForItem() {
    ...
    return t && S(t) ? t.toString().match(/%$/) ? this.getSize(t, t) : t.toString() : null;
  }
}
let q = class extends w {
  ...
  constructor(e, i, a) {
    ...
    r(this, "adaptiveItem");
    r(this, "background");
    this.props = e, this.callback = a, this.type = new _(e), this.data = new D(e, this.type, () => {
      this.adaptiveItem.is() ? this.adaptiveItem.reset() : this.make(!0);
    }), this.coordinator = new N(e), this.position = new L(e, this.coordinator), this.adaptiveItem = new Y(
      e,
      this.data,
      i,
      () => this.make(!0)
...
class Q {
  ...
  constructor(t, e) {
    ...
    ), p(() => this.item.data.make(!0)), p(() => this.item.updateAdaptive());
  }
  /**
   * Destructor
   */
...
class Z extends W {
  ...
  constructor(e, i, a) {
    ...
    this.image = new Q(
      this.props,
      this.element
    ), this.init(), A(() => this.image.destructor()), E(
      this.image.data,
      (o) => {
        var h;
        return (h = this.emits) == null ? void 0 : h.call(this, "load", {
  ...
  setup(s, { expose: t, emit: e }) {
    const i = e, a = s, o = g(() => ({
      main: {
        ...
        "m3-image": !0,
        "m3-image--turn": a.turn,
        "m3-image--disabled": a.disabled,
        "m3-image--hide": a.hide,
        "m3-image--adaptive": a.adaptive
        // :classes-values [!] System label / Системная метка
      }
