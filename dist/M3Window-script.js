...
import { i as S } from "./isFilled-DV8O9-Ib.js";
import { i as p } from "./inArray-BLmbg9f_.js";
import { D as F } from "./DesignConstructorAbstract-_dNu1bTO.js";
import { g as P } from "./getElementId-BUNC3Zxy.js";
import { g as B } from "./getElement-BhVCn14C.js";
import { E as M } from "./EventItem-CYabC4_O.js";
...
class Z {
   ...
   */
  make() {
    this.isStaticMod() ? !this.event && this.element.getMain() && (this.event = new M(
      window,
      ["resize"],
      () => this.listener()
...
class tt {
   ...
   */
  // eslint-disable-next-line no-useless-constructor
  constructor(t, s, i, e, r, h, a, l, u, g, k) {
    n(this, "open", !1);
    n(this, "first", !1);
    this.props = t, this.status = s, this.client = i, this.hook = e, this.element = r, this.flash = h, this.coordinates = a, this.position = l, this.origin = u, this.callback = g, this.callbackEmit = k;
  }
  /**
...
class et {
  ...
  constructor(t, s, i, e, r, h, a) {
    n(this, "event");
    this.props = t, this.status = s, this.client = i, this.persistent = e, this.flash = r, this.open = h, this.verification = a, this.event = new M(
      "body",
      ["click", "contextmenu"],
      (l) => this.onGlobal(l)
    );
...
class it {
  ...
  constructor(t, s, i, e, r = "is-window", h = "is-control", a = "is-body", l = "is-body-context") {
    ...
    n(this, "verification");
    n(this, "event");
    this.status = new _(), this.client = new L(), this.persistent = new U(t, i), this.hook = new G(t), this.classes = new V(
      this.persistent,
      r,
      h,
      a,
