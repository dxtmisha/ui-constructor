...
import { i as a, f as l } from "./forEach-B1ZDH1yu.js";
import { i as g, G as v, c as u } from "./Geo-CsoTI0Xl.js";
import { t as c, G as D } from "./GeoIntl-BknU4dNI.js";
function L(e) {
  return g(e) ? e : a(e) ? JSON.stringify(e) : (e == null ? void 0 : e.toString()) ?? "";
}
function S(e, t = "ig", s = ":value") {
...
function p(e, t, s = !0) {
  ...
  return a(e) && a(t) && l(
    ...
    (n, i) => {
      ...
      a(o) && a(n) ? s && Array.isArray(o) && Array.isArray(n) ? r[i] = u(M([...o, ...n])) : r[i] = p(
        Array.isArray(o) ? { ...o } : o,
        n,
        s
      ) : r[i] = a(n) ? u(n) : n;
