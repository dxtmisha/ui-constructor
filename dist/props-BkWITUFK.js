...
import { C as z, G as x, p as v, i as C, E as H, a as j, m as p, u as W } from "./DesignConstructorAbstract-DKsAcF4G.js";
import { j as d, a as A } from "./Api-BN9TTpr9.js";
import { I as b } from "./Icons-DxBXy78v.js";
...
class h {
   ...
   */
  static make() {
    this.event && this.objects.length < 1 ? (this.event.stop(), this.event = void 0) : this.objects.length > 0 && (this.event = new H(window, ["scroll-sync"], () => this.start()).start(), this.start());
  }
  /**
  ...
  make() {
    ...
    if (this.beyond = !1, this.visible = !1, this.is())
      if ((t = this.props) != null && t.adaptiveAlways)
        ...
        i && (this.beyond = !(i.bottom < 0 - m || i.top > window.innerHeight + m), this.visible = !(i.bottom < 0 || i.top > window.innerHeight));
      }
    return this;
  }
  /**
...
let P = class extends v {
  ...
  constructor(e, i, r) {
    ...
    }), this.coordinator = new O(e), this.position = new $(e, this.coordinator), this.adaptiveItem = new D(
      e,
      this.data,
      i,
      () => this.make(!0)
