...
import { i as c } from "./toNumber-CJS0fvr_.js";
class r {
  /**
   * Constructor
  ...
  isDifferent(t) {
    var s, a;
    return ((s = this.cache) == null ? void 0 : s[t]) !== ((a = this.props) == null ? void 0 : a[t]);
  }
}
class l {
  /**
  ...
  constructor(t, s, a) {
    e(this, "event", {});
    e(this, "changed");
    this.props = t, this.callback = s, this.changed = new r(t, a);
  }
  /**
