...
var I = (r, e, i) => e in r ? w(r, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : r[e] = i;
var h = (r, e, i) => (I(r, typeof e != "symbol" ? e + "" : e, i), i);
import { f as C, i as S } from "./forEach-B1ZDH1yu.js";
import { d as E, G as g, a as A } from "./Api-BTE37me5.js";
import { d as f } from "./toNumber-DcwTJxn8.js";
...
function d(r) {
  ...
  if (typeof r == "number")
    return new Date(r);
  let e = r, i = "";
  r.replace(/^([\s\S]+)([-+]\d{2}:?\d{2})$/, (n, a, o) => (e = a, i = o, n));
...
class N {
  ...
  decimal() {
    var e, i, s, n, a;
    return ((a = (n = (s = (i = (e = this.numberObject()) == null ? void 0 : e.formatToParts) == null ? void 0 : i.call(e, 1.2)) == null ? void 0 : s.find) == null ? void 0 : n.call(s, (o) => o.type === "decimal")) == null ? void 0 : a.value) || ".";
  }
  /**
  ...
  currency(e, i, s = !1) {
    ...
    }, a = e.toString().replace(/^([\S\s]+[\d ])([a-zA-Z]{3})$/i, (...o) => (n.currency = o[2].toUpperCase(), o[1]));
    if (s) {
  ...
  unit(e, i) {
    ...
    }, n = e.toString().replace(/^([\S\s]+[\d ])([a-zA-Z]+)$/i, (...a) => (s.unit = a[2].toLowerCase(), a[1]));
   ...
   */
  date(e, i, s, n) {
    const a = d(e), o = typeof s == "string", $ = this.dateOptions(i, o ? s : "short");
    return n && ($.hour12 = !1), o || Object.assign($, s), a.toLocaleString(this.getLocation(), $);
  }
  /**
   ...
   */
  relative(e, i, s) {
    const n = d(e), a = s || /* @__PURE__ */ new Date(), o = {
      numeric: "auto",
      ...typeof i == "string" ? { style: i } : i || {}
    };
    let $ = "second", c = (n.getTime() - a.getTime()) / 1e3;
   ...
   * @param hour24 whether to use 12-hour time /<br>использовать ли 12-часовое время
   */
  relativeLimit(e, i, s, n, a, o, $) {
    const c = d(e), u = s || /* @__PURE__ */ new Date(), p = new Date(u), b = new Date(u);
    return p.setDate(u.getDate() - i), b.setDate(u.getDate() + i), c >= p && c <= b ? this.relative(
      c,
      n,
      u
    ) : this.date(
  ...
  weekdays(e) {
    ...
    try {
      const s = /* @__PURE__ */ new Date(), n = Intl.DateTimeFormat(this.getLocation(), { weekday: e || "long" }), a = s.getDay() + (this.geo.firstDay === "Mo" ? -1 : 1);
  ...
  sort(e, i = (s, n) => [s, n]) {
    ...
    return e.sort((n, a) => s.compare(...i(n, a)));
  }
  /**
...
const y = {}, t = "@flag", m = class m {
  ...
  get(e = this.code) {
    ...
    if (i) {
      ...
      return {
        ...
        country: n,
        standard: i.standard,
        icon: (s = m.flags) == null ? void 0 : s[i.country],
        label: n,
        value: i.country
      };
    }
  ...
  getNational(e) {
    return C(this.getList(e), (i) => {
      const s = new m(i.language).get(i.standard);
      return {
        ...i,
...
function k(r) {
  var e;
  return !!((e = l(r)) != null && e.closest("html"));
}
class U {
  /**
   * Classes Constructor
  ...
  constructor(e, i = ["click"], s, n, a) {
    ...
    h(this, "listenerRecent", (e) => {
      var i, s;
      k(this.elementControl) ? ((i = this.listener) == null || i.call(this.element, e, this.detail), S(this.options) && ((s = this.options) != null && s.once) && this.stop()) : this.stop();
    });
    /**
     * Event states.<br>
     * Состояния события.
    ...
    this.listener = s, this.options = n, this.detail = a, this.element = D(e), this.elementControl = l(e), this.type = L(i);
  }
  /**
  ...
  setElement(e) {
    const i = D(e);
    return this.elementControlEdit || (this.elementControl = l(e)), this.element = i, this.reset(), this;
  }
  /**
   ...
   */
  setElementControl(e) {
    return this.elementControl = l(e), this.elementControlEdit = !E(this.elementControl), this.elementControlEdit || (this.elementControl = l(this.element)), this;
  }
  /**
