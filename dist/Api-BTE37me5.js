...
class L {
  ...
  set(n) {
    var e, o;
    return this.value = T(n), this.age = (/* @__PURE__ */ new Date()).getTime(), this.value === void 0 ? (e = this.getMethod()) == null || e.removeItem(this.getIndex()) : (o = this.getMethod()) == null || o.setItem(this.getIndex(), JSON.stringify({
      value: this.value,
      age: this.age
    })), this.value;
  }
...
u(t, "storage", new L(_)), u(t, "location"), u(t, "item"), u(t, "language"), t.location = t.findLocation(), t.language = t.findLanguage(t.location), t.item = t.getByCode(t.location);
let l = t;
var N = /* @__PURE__ */ ((a) => (a.get = "GET", a.post = "POST", a.put = "PUT", a.delete = "DELETE", a))(N || {});
class d {
  /**
