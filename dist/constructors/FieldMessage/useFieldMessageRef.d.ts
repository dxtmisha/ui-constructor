 ...
 */
export declare const useFieldMessageRef: <COMP extends UseFieldMessageComponent, P extends UseFieldMessageCounterProps>(props: P, components?: DesignComponents<COMP, P> | undefined, validationMessage?: RefOrNormal<string>) => UseFieldMessageSetup;
