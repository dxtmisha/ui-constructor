...
import { g as v, a as G, d as M, G as p, f as g } from "./Api-BN9TTpr9.js";
import { t as f } from "./toArray-rswbj5Xf.js";
import { isRef as R, h as O, toRefs as B, useAttrs as j, useSlots as F, ref as z, computed as y } from "vue";
function w(n) {
...
function et(n, t) {
  const s = $(n);
  return s ? (G(s.id) || s.setAttribute("id", `id-${L++}`), t ? `#${s.id}${t}`.trim() : s.id) : `id-${L++}`;
}
function S(n) {
  return I(n) ? n : $(n);
}
...
class it {
  ...
  constructor(t, s = ["click"], i, r, a) {
    ...
    o(this, "listenerRecent", (t) => {
      var s, i;
      K(this.elementControl) ? ((s = this.listener) == null || s.call(this.element, t, this.detail), v(this.options) && ((i = this.options) != null && i.once) && this.stop()) : this.stop();
    });
    /**
     * Event states.<br>
     * Состояния события.
    ...
    this.listener = i, this.options = r, this.detail = a, this.element = S(t), this.elementControl = $(t), this.type = f(s);
  }
  /**
...
class Y {
   ...
   */
  is(t) {
    return U(t) ? !!t.find((s) => this.isDifferent(s)) : this.isDifferent(t);
  }
  /**
...
class q {
  ...
  constructor(t, s, i) {
    o(this, "event", {});
    o(this, "changed");
    this.props = t, this.callback = s, this.changed = new Y(t, i);
  }
  /**
...
class J {
  ...
  getModification(t, s) {
    var i;
    if (t) {
      const r = k((i = this.modification) == null ? void 0 : i[t]);
      if (r && w(r)) {
        const a = {};
        return g(r, (c, h) => {
          a[h] = k(c);
...
class nt {
  ...
  constructor(t, s, i) {
    ...
    o(this, "data");
    o(this, "dataExpose");
    this.props = s, this.name = this.initName(t), this.refs = this.props ? B(this.props) : {}, this.components = new J(i == null ? void 0 : i.components, i == null ? void 0 : i.compMod), this.emits = i == null ? void 0 : i.emits, this.classes = i == null ? void 0 : i.classes, this.styles = i == null ? void 0 : i.styles, this.attrs = j(), this.slots = F();
  }
  init() {
