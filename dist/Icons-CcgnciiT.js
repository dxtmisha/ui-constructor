...
import { u as d, k as f, f as o } from "./Api-DYbVHTIo.js";
const s = class s {
  /**
  ...
  static async get(t, i = "") {
    var c, n;
    const e = ((c = this.icons) == null ? void 0 : c[this.getName(t)]) ?? ((n = this.icons) == null ? void 0 : n[t]) ?? `${t.replace(/^@/, i ?? this.url)}.svg`;
   ...
   */
  static getNameList() {
    return o(this.icons, (t, i) => i.replace(/^@/, ""));
  }
  /**
