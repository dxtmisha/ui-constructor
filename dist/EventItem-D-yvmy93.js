...
class N {
  ...
  relativeLimit(e, i, s, n, a, o, $) {
    const c = d(e), m = s || /* @__PURE__ */ new Date(), p = new Date(m), b = new Date(m);
    return p.setDate(m.getDate() - i), b.setDate(m.getDate() + i), c >= p && c <= b ? this.relative(
      c,
      n,
      m
    ) : this.date(
...
class j {
  ...
  constructor(e, i = ["click"], s, n, a) {
    ...
    l(this, "listenerRecent", (e) => {
      var i, s;
      k(this.elementControl) ? ((i = this.listener) == null || i.call(this.element, e, this.detail), w(this.options) && ((s = this.options) != null && s.once) && this.stop()) : this.stop();
    });
    /**
     * Event states.<br>
     * Состояния события.
    ...
    this.listener = s, this.options = n, this.detail = a, this.element = D(e), this.elementControl = h(e), this.type = L(i);
  }
  /**
  ...
  setElement(e) {
    const i = D(e);
    return this.elementControlEdit || (this.elementControl = h(e)), this.element = i, this.reset(), this;
  }
  /**
   ...
   */
  setElementControl(e) {
    return this.elementControl = h(e), this.elementControlEdit = !E(this.elementControl), this.elementControlEdit || (this.elementControl = h(this.element)), this;
  }
  /**
