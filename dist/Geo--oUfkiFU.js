...
import { i as g, D as p, a as h, u as y } from "./DataStorage-Bv8gu1PM.js";
function k(o) {
...
function f(o, n) {
  return g(o) ? !1 : Array.isArray(n) ? n.includes(o) : o === n;
}
const M = [
  {
    country: "US",
  ...
  static findLocation() {
    var n;
    return h() && (this.storage.get() || ((n = document.querySelector("html")) == null ? void 0 : n.lang) || navigator.language || navigator.languages[0] || y("language")) || "en-GB";
  }
  /**
...
u(e, "storage", new p(d)), u(e, "location"), u(e, "item"), u(e, "language"), e.location = e.findLocation(), e.language = e.findLanguage(e.location), e.item = e.getByCode(e.location);
let s = e;
export {
  s as G,
  f as a,
