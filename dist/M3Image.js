...
class R extends S {
  ...
  update() {
    ...
    if (t) {
      ...
      return i ? i[1] : w.is(t) ? n.public : n.material;
    }
  }
}
const _ = 720;
class G {
   ...
   */
  static getSRC(t, e, i = _) {
    var a;
    if ((e instanceof File || e === void 0) && (t.naturalHeight > i || t.naturalWidth > i)) {
      const h = t.naturalWidth >= t.naturalHeight, o = (a = document.createElement("canvas")) == null ? void 0 : a.getContext("2d");
      return o ? (o.canvas.width = h ? i : t.naturalWidth / t.naturalHeight * i, o.canvas.height = h ? t.naturalHeight / t.naturalWidth * i : i, o.drawImage(t, 0, 0, o.canvas.width, o.canvas.height), o.canvas.toDataURL()) : "";
    } else
      return t.src;
  }
  /**
...
class D extends b {
  ...
  constructor(e, i, a) {
    ...
    super(e, a, ["value", "url"]);
    r(this, "item");
    this.type = i, (h = this.props) != null && h.value && this.make();
  }
  /**
  ...
  async initImage() {
    ...
    if (e)
      switch (this.type.get()) {
        ...
        case n.icon:
          if (d(e))
            return await w.get(e, (a = this.props) == null ? void 0 : a.url);
          break;
      }
  }
}
class N {
  ...
  is() {
    ...
    return z(t) && t.length > 0 && t.length < 5;
  }
  /**
...
class c {
   ...
   */
  static make() {
    this.event && this.objects.length < 1 ? (this.event.stop(), this.event = void 0) : this.objects.length > 0 && (this.event = new C(window, ["scroll-sync"], () => this.start()).start(), this.start());
  }
  /**
    ...
    u.isSize() && this.objectsAdaptive.forEach((t) => {
      ...
      if (e) {
        ...
        t.setPercent(
          ...
          t.getHeight() * (h ? 1 / h : 0) * (i.getOffsetHeight() / e.offsetHeight)
        );
      }
    });
  }
