...
var M = (e, n, a) => n in e ? f(e, n, { enumerable: !0, configurable: !0, writable: !0, value: a }) : e[n] = a;
var t = (e, n, a) => (M(e, typeof n != "symbol" ? n + "" : n, a), a);
import { i as d } from "./isFilled-Bk7ZeS55.js";
import { i as C, D, a as k, u as g } from "./DataStorage-DLhLvnDX.js";
function h(e) {
...
function A(e, n) {
  return C(e) ? !1 : Array.isArray(n) ? n.includes(e) : e === n;
}
const S = [
  {
    country: "US",
  ...
  static getByCode(n) {
    let a;
    return n && (n.match(/([A-Z]{2}-[a-z]{2})|([a-z]{2}-[A-Z]{2})/) && (a = this.getByCodeFull(n)), !a && n.match(/[A-Z]{2}/) && (a = this.getByCountry(this.toCountry(n))), !a && n.match(/[a-z]{2}/) && (a = this.getByLanguage(this.toLanguage(n)))), this.toFull(z(a ?? this.getList()[0]));
  }
  /**
  ...
  static getByCountry(n) {
    return this.getList().find((a) => {
      var r;
      return a.country === n || ((r = a == null ? void 0 : a.countryAlternative) == null ? void 0 : r.find((u) => u === n));
    });
  }
  /**
  ...
  static getByLanguage(n) {
    return this.getList().find((a) => {
      var r;
      return a.language === n || ((r = a == null ? void 0 : a.languageAlternative) == null ? void 0 : r.find((u) => u === n));
    });
  }
  /**
  ...
  static findLocation() {
    var n;
    return k() && (this.storage.get() || ((n = document.querySelector("html")) == null ? void 0 : n.lang) || navigator.language || navigator.languages[0] || g("language")) || "en-GB";
  }
  /**
...
t(o, "storage", new D(m)), t(o, "location"), t(o, "item"), t(o, "language"), o.location = o.findLocation(), o.language = o.findLanguage(o.location), o.item = o.getByCode(o.location);
let s = o;
var E = /* @__PURE__ */ ((e) => (e.get = "GET", e.post = "POST", e.put = "PUT", e.delete = "DELETE", e))(E || {});
class l {
  /**
   ...
   */
  static getHeaders(n, a = "application/json;charset=UTF-8") {
    if (n !== null) {
      const r = { ...n || {} };
      return a && (r["Content-Type"] = a), r;
    }
  }
  /**
  ...
  static getBody(n) {
    if (d(n))
      return n instanceof FormData || h(n) ? n : JSON.stringify(n);
  }
  /**
   ...
   */
  static async responseByCommand(n, a) {
  ...
  static async fetch({
    ...
    try {
      const i = this.getHeaders(u, p), c = i && a === "GET" ? "POST" : a;
...
t(l, "url", g("api", "/")), t(l, "urlLocalhost", `${g("BASE_URL", "/")}public/`), t(l, "urlCommand", "ui");
export {
  l as A,
  s as G,
  A as a,
