...
import { u as f, k as o, f as m, a as r, G as g, j as y } from "./Api-BN9TTpr9.js";
...
class c {
  ...
  static add(t) {
    return new Promise((s) => {
      this.cache.push(...L(t)), this.resolveList.push(s), this.timeout && clearTimeout(this.timeout), this.timeout = setTimeout(() => {
  ...
  static addSync(t) {
    m(t, (s, i) => {
      y(s) && r(s) && (this.data[this.getName(i)] = s);
    });
  }
  /**
