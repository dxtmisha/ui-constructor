...
import { j as Et, g as b, f as m, e as k, h as vt, c as P, D as J, u as X, i as Y, a as N, t as tt, G as x, k as Le, A as ke, E as xe, b as $e, d as Te } from "./Api-BN9TTpr9.js";
import { g as et, d as wt, f as v, t as Ut, C as Ht, l as G, o as Dt, a as Kt, E as Yt, n as Zt, D as je, p as Fe, q as Ve, s as Pe, u as Be, G as Ge, j as Re, b as We, k as Ue, i as He, c as Ke, e as Ye, r as Ze, h as qe, m as Qe } from "./DesignConstructorAbstract-DKsAcF4G.js";
import { computed as d, isRef as ze, ref as St, inject as Je, watch as C, effectScope as Xe, reactive as ti, createApp as ei, triggerRef as ii, shallowRef as W, watchEffect as si } from "vue";
import { t as qt } from "./toArray-rswbj5Xf.js";
import { I as ri } from "./Icons-DxBXy78v.js";
import { T as Z } from "./Translate-xfpE4kJo.js";
import { createRouter as ni } from "vue-router";
function oi(i) {
...
function di(i) {
  return Math.max(...Ot(i));
}
function fi(i) {
  return Math.min(...Ot(i));
}
function ie(i) {
  var t, e;
...
function re(i, t = {}, e = "value") {
  const s = typeof t == "string", r = s ? t : e, n = s ? {} : t;
  return i ? i && wt(i) && r in i ? {
    ...n,
    ...i
  } : {
    ...n,
...
function _i(i, t = {}, e = "value") {
  return d(() => re(i == null ? void 0 : i.value, v(t), e));
}
function A(i) {
  return ze(i) ? i : St(i);
}
...
const jt = "d-mutation", Si = it(X("DESIGNS_MAIN", "design")), Oi = it(X("DESIGNS_GLOBAL", "ui")), L = "__UI_PROJECT";
class w {
  /**
...
var rt = "store";
function fe(i) {
  return i === void 0 && (i = null), Je(i !== null ? i : rt);
}
function ji(i, t) {
  return i.filter(t)[0];
}
...
function nt(i, t, e, s, r) {
  ...
  if (s.namespaced && (i._modulesNamespaceMap[o] && process.env.NODE_ENV !== "production" && console.error("[vuex] duplicate namespace " + o + " for the namespaced module " + e.join("/")), i._modulesNamespaceMap[o] = s), !n && !r) {
    var a = It(t, e.slice(0, -1)), c = e[e.length - 1];
...
var Ui = "vuex bindings", Ft = "vuex:mutations", dt = "vuex:actions", F = "vuex", Hi = 0;
function Ki(i, t) {
  Ti(
    {
      id: "org.vuejs.vuex",
...
var Vt = 8702998, Yi = 6710886, Zi = 16777215, ye = {
  label: "namespaced",
  textColor: Zi,
  backgroundColor: Yi
};
...
var y = function i(t) {
  ...
  nt(this, u, [], this._modules.root), At(this, u), s.forEach(function(f) {
    return f(e);
  });
}, Lt = { state: { configurable: !0 } };
...
Lt.state.get = function() {
  return this._state.data;
};
Lt.state.set = function(i) {
...
y.prototype.registerModule = function(t, e, s) {
  s === void 0 && (s = {}), typeof t == "string" && (t = [t]), process.env.NODE_ENV !== "production" && (S(Array.isArray(t), "module path must be a string or an Array."), S(t.length > 0, "cannot register the root module by using registerModule.")), this._modules.register(t, e), nt(this, this.state, t, this._modules.get(t), s.preserveState), At(this, this.state);
};
...
Object.defineProperties(y.prototype, Lt);
var kt = at(function(i, t) {
  var e = {};
  ...
  return {
    mapState: kt.bind(null, i),
    mapGetters: $t.bind(null, i),
    mapMutations: xt.bind(null, i),
    mapActions: Tt.bind(null, i)
  };
};
function ot(i) {
...
function Oe(i) {
  ...
  return l === void 0 && (l = console), function(u) {
    ...
    typeof l > "u" || (a && u.subscribe(function(g, p) {
      var I = _t(p);
      if (e(g, f, I)) {
        var ut = Wt(), ht = r(g), Ae = "mutation " + g.type + ut;
        Gt(l, Ae, t), l.log("%c prev state", "color: #9E9E9E; font-weight: bold", s(f)), l.log("%c mutation", "color: #03A9F4; font-weight: bold", ht), l.log("%c next state", "color: #4CAF50; font-weight: bold", s(I)), Rt(l);
      }
      f = I;
    }), c && u.subscribeAction(function(g, p) {
      if (n(g, p)) {
        var I = Wt(), ut = o(g), ht = "action " + g.type + I;
        Gt(l, ht, t), l.log("%c action", "color: #03A9F4; font-weight: bold", ut), Rt(l);
      }
    }));
  };
}
...
class ss {
  ...
  constructor(t, e = "date", s = x.getLocation()) {
    ...
    this.item = A(t), this.type = A(e), this.code = A(s), this.date = St(G(this.item.value)), this.datetime = new st(
      this.date.value,
      this.type.value,
      this.code.value
    ), C(this.item, (r) => {
      this.date.value = G(r);
    }), C(this.type, (r) => this.datetime.setType(r)), C(this.code, (r) => this.datetime.setCode(r)), C(this.date, (r) => this.datetime.setDate(r)), this.datetime.setWatch(() => ii(this.date));
  }
  /**
...
class os {
  ...
  constructor(t) {
    h(this, "location");
    h(this, "intl");
    this.location = A(t), this.intl = d(() => new Dt(this.location.value ?? R.getLanguage().value));
  }
  /**
...
function as(i, t, e) {
  if (i in ft)
    return ft[i];
  const s = new ae(i), r = St(s.get(t, e));
  return C(r, (n) => {
    s.set(n, e);
  }), ft[i] = r, r;
}
...
const ls = (i) => Ne(i), Cs = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Api: Le,
  ApiMethodItem: ke,
  Cache: oe,
  ...
  getKey: li,
  getLengthOfAllArray: Ot,
  getMaxLengthAllArray: di,
  getMinLengthAllArray: fi,
  getMouseClient: gi,
  getMouseClientX: ie,
  getMouseClientY: se,
  getRef: v,
