...
import { D as g, i as p, u as h } from "./DataStorage-BS0mwKb9.js";
import { i as y } from "./isNull-CjWwlQS3.js";
function z(o) {
...
function f(o, n) {
  return y(o) ? !1 : Array.isArray(n) ? n.includes(o) : o === n;
}
const M = [
  {
    country: "US",
  ...
  static getByCode(n) {
    let a;
    return n && (n.match(/([A-Z]{2}-[a-z]{2})|([a-z]{2}-[A-Z]{2})/) && (a = this.getByCodeFull(n)), !a && n.match(/[A-Z]{2}/) && (a = this.getByCountry(this.toCountry(n))), !a && n.match(/[a-z]{2}/) && (a = this.getByLanguage(this.toLanguage(n)))), this.toFull(c(a ?? this.getList()[0]));
  }
  /**
  ...
  static getByCountry(n) {
    return this.getList().find((a) => {
      var r;
      return a.country === n || ((r = a == null ? void 0 : a.countryAlternative) == null ? void 0 : r.find((t) => t === n));
    });
  }
  /**
  ...
  static getByLanguage(n) {
    return this.getList().find((a) => {
      var r;
      return a.language === n || ((r = a == null ? void 0 : a.languageAlternative) == null ? void 0 : r.find((t) => t === n));
    });
  }
  /**
  ...
  static findLocation() {
    var n;
    return p() && (this.storage.get() || ((n = document.querySelector("html")) == null ? void 0 : n.lang) || navigator.language || navigator.languages[0] || h("language")) || "en-GB";
  }
  /**
...
u(e, "storage", new g(d)), u(e, "location"), u(e, "item"), u(e, "language"), e.location = e.findLocation(), e.language = e.findLanguage(e.location), e.item = e.getByCode(e.location);
let s = e;
export {
  s as G,
  f as a,
