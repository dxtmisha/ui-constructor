...
var d = (i, e, t) => e in i ? g(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t;
var u = (i, e, t) => (d(i, typeof e != "symbol" ? e + "" : e, t), t);
import { e as I } from "./executeFunction-B6By_8Og.js";
function f(i) {
  return i == null;
}
function v() {
...
class T {
  ...
  set(e) {
    var t, s;
    return this.value = I(e), this.age = (/* @__PURE__ */ new Date()).getTime(), this.value === void 0 ? (t = this.getMethod()) == null || t.removeItem(this.getIndex()) : (s = this.getMethod()) == null || s.setItem(this.getIndex(), JSON.stringify({
      value: this.value,
      age: this.age
    })), this.value;
  }
