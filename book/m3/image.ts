...
export const imageDescription: string = 'Component for displaying graphic materials. ' +
...
export const imageDescriptionAdaptive: string = '<p>For an image with products, you can align the sizes of the elements ' +
