...
export const m3ProgressDescription: string = 'Компонент для работы с отображением загрузчика.'

export const m3ProgressArgs: StorybookArgs = {
  // Status
  visible: {
...
export const m3ProgressValues: StorybookArgsValue = {
  visible: true
}
