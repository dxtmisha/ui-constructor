...
import { M3Mask } from 'ui/M3Mask'

import {
  M3MaskArgs,
  M3MaskDescription,
  M3MaskValues
} from 'ui/book/m3/mask.ts'
...
export const MaskNumber: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '<p>Это готовая маска для ввода числа. ' +
...
export const MaskCurrency: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Это готовая маска для ввода цены. ' +
          'Через свойство currency можно указывать валюту. ' +
          'Если не указать currency, то будет вести как тип number'
      }
    }
  },
  render: (args: any) => ({
...
export const MaskGroup: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Можно передать в свойство special объект для настройки маски с разными группами вводимых символов. ' +
          'Например, нужно сделать маску, где первые 4 символа - это буквы, а последние 6 - числа.'
      }
    }
  },
  render: (args: any) => ({
